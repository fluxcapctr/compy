...
fn record(id: Uuid, name: &str, placement: (f64, f64, f64, f64), parent: Option<Uuid>, hidden: bool, opacity: u8, blend: BlendMode) -> Layer {
    ...
    Layer {
        ...
        blend_mode: if blend == BlendMode::Normal { None } else { Some(blend) }, mask_file: None, mask_enabled: None, mask_source_id: None, adjustment: None, mask_placement: None, mask_linked: None, shape: None, text: None, effects: None, artboard: None,
    }
}
