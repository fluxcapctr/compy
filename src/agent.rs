...
pub fn tools() -> Vec<ToolSpec> {
    vec![
        ...
        ToolSpec { name: "filter", description: "Run a filter on the active layer: gaussian_blur (radius), motion_blur (angle, distance), add_noise (amount), unsharp_mask (amount %, radius, threshold), smart_sharpen (amount %, radius, noise %; sharpens brightness only), levels (black, white, gamma), exposure (exposure), hue_saturation (hue, saturation, lightness), color_balance (shadows, midtones, highlights: each [cyan_red, magenta_green, yellow_blue] from -100 to 100), brightness_contrast (brightness -150 to 150, contrast -50 to 100), vibrance (vibrance, saturation -100 to 100), black_white (reds, yellows, greens, cyans, blues, magentas in percent), photo_filter (color #rrggbb, density 1 to 100, preserve_luminosity), threshold (level 1 to 255), posterize (levels 2 to 255).", schema: obj(json!({"kind": {"type": "string"}, "radius": {"type": "number"}, "angle": {"type": "number"}, "distance": {"type": "number"}, "amount": {"type": "number"}, "threshold": {"type": "number"}, "noise": {"type": "number"}, "black": {"type": "number"}, "white": {"type": "number"}, "gamma": {"type": "number"}, "exposure": {"type": "number"}, "hue": {"type": "number"}, "saturation": {"type": "number"}, "lightness": {"type": "number"}, "shadows": {"type": "array"}, "midtones": {"type": "array"}, "highlights": {"type": "array"}, "brightness": {"type": "number"}, "contrast": {"type": "number"}, "vibrance": {"type": "number"}, "reds": {"type": "number"}, "yellows": {"type": "number"}, "greens": {"type": "number"}, "cyans": {"type": "number"}, "blues": {"type": "number"}, "magentas": {"type": "number"}, "color": {"type": "string"}, "density": {"type": "number"}, "preserve_luminosity": {"type": "boolean"}, "level": {"type": "number"}, "levels": {"type": "number"}}), &["kind"]) },
        ToolSpec { name: "adjustment_layer", description: "Add a non-destructive adjustment layer above the active layer: levels (black, white, gamma), exposure (exposure), hue_saturation (hue, saturation, lightness), gradient_map, curves, brightness_contrast (brightness, contrast), vibrance (vibrance, saturation), black_white (reds, yellows, greens, cyans, blues, magentas), photo_filter (color, density, preserve_luminosity), threshold (level), posterize (levels). It affects every layer below unless clip is true (then only the layer directly below).", schema: obj(json!({"kind": {"type": "string"}, "clip": {"type": "boolean"}, "black": {"type": "number"}, "white": {"type": "number"}, "gamma": {"type": "number"}, "exposure": {"type": "number"}, "hue": {"type": "number"}, "saturation": {"type": "number"}, "lightness": {"type": "number"}, "brightness": {"type": "number"}, "contrast": {"type": "number"}, "vibrance": {"type": "number"}, "reds": {"type": "number"}, "yellows": {"type": "number"}, "greens": {"type": "number"}, "cyans": {"type": "number"}, "blues": {"type": "number"}, "magentas": {"type": "number"}, "color": {"type": "string"}, "density": {"type": "number"}, "preserve_luminosity": {"type": "boolean"}, "level": {"type": "number"}, "levels": {"type": "number"}}), &["kind"]) },
