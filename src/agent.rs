...
pub fn tools() -> Vec<ToolSpec> {
    vec![
        ...
        ToolSpec { name: "export", description: "Write the visible composite to a PNG, JPEG or WebP file (path with .png, .jpg or .webp).", schema: obj(json!({"path": {"type": "string"}, "quality": {"type": "number"}}), &["path"]) },
