...
const SCENES: Scene[] = [
  { key: "curves", bar: 0, bars: 2, layout: "full",
    ...
    cap: { eyebrow: "Adjustments", title: "Curves on the real thing.", sub: "Levels, Curves, Hue/Saturation, live previews." } },
  ...
  { key: "type", bar: 5, bars: 2, layout: "full",
    ...
    cap: { eyebrow: "Type", title: "Type behind the subject.", sub: "Any font on your system. Editable forever." } },
  { key: "style", bar: 7, bars: 1, layout: "tilt",
    parts: [{ from: 22.5, to: 25.7, beats: 4 }],
    cap: { eyebrow: "Layer styles", title: "Every layer style.", sub: "Shadows, glows, bevels, strokes, overlays." } },
  { key: "type2", bar: 8, bars: 1, layout: "full",
    parts: [{ from: 26.0, to: 28.8, beats: 4 }],
    cams: [{ t: 0, x: 820, y: 1010, z: 1.35 }, { t: 2.0, x: 820, y: 990, z: 1.75 }],
    cap: { eyebrow: "Type", title: "Set it like a magazine.", sub: "Point and paragraph type, real alignment." }, capTop: true },
  { key: "genfill", bar: 9, bars: 2, layout: "full",
    ...
    cap: { eyebrow: "Generative Fill", title: "Paint with a prompt.", sub: "“Two flamingos, far off.” Matched to the light." },
